...
const SummaryHeader = ({
    ...
    return <div className="flex items-start gap-2 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
            <h3 className="text xl:text-lg font-semibold text-grey-900 truncate w-4/5 ">{title || formatFileName(fileUrl)} </h3>
...
export default function SummaryCard({summary}:{summary:any}){
    return <MotionDiv
                            ...
                            initial="hidden"
                            animate="visible"
                            whileHover={{scale:1.02, transition:{duration:0.02,ease:"easeOut"}}}
